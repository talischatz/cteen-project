...
export const Contents = () => {
  return (
    <div className="p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
      ...
      <Image src={cansado} alt="cansado"/>
      <Image src={costoso} alt="costoso"/>
      <Image src={decisiones} alt="decisiones"/>
      <Image src={creciendo} alt="creciendo"/>
      <Image src={desafiante} alt="desafiante"/>
      <Image src={destino} alt="destino"/>
      <Image src={disciplinado} alt="disciplinado"/>
      <Image src={escuela} alt="escuela"/>
      <Image src={grandesplanes} alt="grandesplanes"/>
      <Image src={hambrientas} alt="hambrientas"/>
      <Image src={labordeamor} alt="labordeamor"/>
      <Image src={maestros} alt="maestros"/>
      <Image src={manzal} alt="manzal"/>
      <Image src={nobel} alt="nobel"/>
      <Image src={pleno} alt="pleno"/>
      <Image src={poderoso} alt="poderoso"/>
      <Image src={prefacio} alt="prefacio"/>
      <Image src={principalobjetivo} alt="principalobjetivo"/>
      <Image src={rebe} alt="rebe"/>
      <Image src={regalo} alt="regalo"/>
      <Image src={saludable} alt="saludable"/>
      <Image src={semillasdesabiduria} alt="semillasdesabiduria"/>
      <Image src={senderos} alt="senderos"/>
      <Image src={sobreviviente} alt="sobreviviente"/>
      <Image src={vela} alt="vela"/>
    </div>
  )
}
